      ...
      <div className="mx-auto max-w-3xl px-4 py-12 lg:px-8">
        ...
        <div className="space-y-8 text-sm leading-relaxed text-zinc-300">
          ...
          <section className="space-y-2">
            ...
            <p className="font-medium text-zinc-200 mt-3 mb-1">자동 수집 정보</p>
            ...
            <p className="font-medium text-zinc-200 mt-3 mb-1">문의 양식을 통해 수집하는 정보</p>
            <ul className="list-disc space-y-1 pl-5 text-zinc-400">
          ...
          <section className="space-y-2">
            ...
            <div className="space-y-3">
              ...
              <div className="rounded-lg border border-zinc-800 bg-zinc-900/40 px-4 py-3">
                ...
                <ul className="mt-2 space-y-1 text-zinc-500 text-xs list-disc pl-4">
                  <li>
                    <a href="https://www.google.com/settings/ads" target="_blank" rel="noopener noreferrer"
                      className="text-amber-400/80 underline">Google 광고 설정</a>
                    {" "}— Google 개인화 광고 비활성화
                  </li>
                  <li>
                    <a href="https://optout.networkadvertising.org/" target="_blank" rel="noopener noreferrer"
                      className="text-amber-400/80 underline">NAI 광고 거부 페이지</a>
                    {" "}— 제3자 광고 네트워크 옵트아웃
                  </li>
                </ul>
              </div>
          ...
          <section className="space-y-2">
            ...
            <ul className="list-disc space-y-1 pl-5 text-zinc-400">
              <li>
                <a href="https://www.google.com/settings/ads" target="_blank" rel="noopener noreferrer"
                  className="text-amber-400/80 underline">Google 광고 설정 페이지</a>에서 개인화 광고 해제
              </li>
              <li>브라우저의 쿠키 차단 또는 광고 차단 확장 프로그램 사용</li>
              <li>
                <a href="https://optout.aboutads.info/" target="_blank" rel="noopener noreferrer"
                  className="text-amber-400/80 underline">DAA(Digital Advertising Alliance)</a>
                {" "}옵트아웃 도구 이용
              </li>
            </ul>
            <p className="mt-2 text-zinc-500 text-xs">
