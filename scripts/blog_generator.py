...
TOPICS = [
    # 가전/IT
    {"key": "airfryer_review",          "title": "에어프라이어 추천 TOP 5 — 직접 써본 솔직 리뷰",        "category": "가전/IT",   "search_keyword": "에어프라이어"},
    ...
    {"key": "smart_tv_review",          "title": "저렴한 스마트 TV 추천 — 40인치대 비교 리뷰",           "category": "가전/IT",   "search_keyword": "스마트TV"},
    ...
    {"key": "coffee_maker",             "title": "가정용 커피머신 추천 — 10만원대 가성비 TOP 5",         "category": "주방",      "search_keyword": "커피머신"},
    {"key": "induction_cooktop",        "title": "인덕션 추천 — 1구부터 2구까지 가정용 비교 리뷰",        "category": "주방",      "search_keyword": "인덕션"},
    ...
    # 뷰티/헬스
    {"key": "sunscreen_review",         "title": "선크림 추천 — SPF 높고 백탁 없는 제품 TOP 7",         "category": "뷰티/헬스", "search_keyword": "선크림"},
    {"key": "facial_massager",          "title": "얼굴 마사지기 추천 — 피부 탄력 개선 실제 후기",         "category": "뷰티/헬스", "search_keyword": "얼굴마사지기"},
    ...
    {"key": "portable_fan",             "title": "휴대용 선풍기 추천 — 여름 필수템 가성비 TOP 5",        "category": "아이디어",  "search_keyword": "휴대용선풍기"},
    ...
    # 식품
    {"key": "protein_powder",           "title": "단백질 보충제 추천 — 맛·성분 모두 잡은 가성비 TOP 5", "category": "식품",      "search_keyword": "단백질보충제"},
...
- 추천 대상 / 비추천 대상 명확히 구분{"" if not products else chr(10) + "- 위 쿠팡 상품 데이터의 실제 제품명·가격·평점을 리뷰에 구체적으로 반영할 것"}
